...
(function() {
    ...
    Global.Controls.register("vec2", new VectorControlFactory(2));
    Global.Controls.register("vec3", new VectorControlFactory(3));
    Global.Controls.register("vec4", new VectorControlFactory(4));
