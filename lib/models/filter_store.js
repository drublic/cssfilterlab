...
(function() {
    ...
    $.extend(FilterStore.prototype, {
        ...
        onFileSystemCreated: function(fileSystem) {
            ...
            // Params for function: err, dirEntry; not used
            this.fileSystem.createDirectory(this.shadersFolders.vertex, function() {
                // Params for function: err, dirEntry; not used
                self.fileSystem.createDirectory(self.shadersFolders.fragment, function() {
                    self.readForks();
                });
            });
        },
