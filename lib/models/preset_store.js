...
(function(){
	...
	$.extend(PresetStore.prototype, {
		...
		saveAnimation: function() {
			...
			// var self = this,
			var data = this.animation.dumpAnimation(),
		...
		savePresetAs: function() {
			var newName = window.prompt("New preset name:");
			if (!newName) {
				return;
            }
		...
		deletePreset: function(preset) {
            ...
            // Param for function: err; not used
			this.fileSystem.deleteFile(this.presetFileName(preset), function() {
				// Done.
